...
//helper function for bringing the individual restaurant info in
function fillInfo(info) {
	...
	//this should center and zoom in the map on the restaurant marker when the restaurant page loads
	myMap.setView(latLong, 19);
}
